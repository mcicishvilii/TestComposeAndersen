...
fun FillingIconScreen() {
    ...
    Column(
        ...
        FillingIcon(progress, R.drawable.ic_28_forte_logo_2__1_, androidIconPath)
        Slider(
            value = progress,
